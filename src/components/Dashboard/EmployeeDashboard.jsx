...
//console.log(prop.data.tasks.task);
...
return(<>  
   ...
   <div id="taskstatuslist" className="flex mt-10 overflow-x-auto">
      <div className="bg-blue-500  w-56 pl-8 pr-8 pt-5 pb-5 rounded ml-5">
         <div className="text-gray-50 font-bold text-xl ml-10">{prop.data.tasks.values.new_task}</div>
      ...
      <div className="bg-green-600  w-56  pl-8 pr-8 pt-5 pb-5 rounded ml-5">
         <div className="text-gray-50 font-bold text-xl ml-10">{prop.data.tasks.values.completed}</div>
      ...
      <div className="bg-red-500 w-56   pl-8 pr-8 pt-5 pb-5 rounded ml-5 ">
         <div className="text-gray-50 font-bold text-xl ml-10">{prop.data.tasks.values.failed}</div>
