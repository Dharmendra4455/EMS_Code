...
function Failed(prop){
  ...
  const activebutton=()=>{
   ...
   <div className=" w-72 h-64  bg-red-400 mt-3 ml-5 flex-nowrap  flex-shrink-0 rounded-md overflow-hidden">
         ...
         <button id="activebutton" onClick={activebutton} className=" bg-yellow-500 h-fit w-fit ml-2 pl-3 pr-3 pt-1 pb-1 mt-2 rounded text-slate-50 ">Re-Active</button>
            <div className=" pt-2 text-white pr-2 font-bold">{prop.task.task_date}</div>
         </div>
