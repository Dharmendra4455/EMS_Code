function Completed(){
   ...
   <div className="w-60 h-56  bg-gray-700 mt-3 ml-5 flex-nowrap  flex-shrink-0  rounded-md overflow-auto ">
      ...
      <h2 className="ml-5 mt-5 mr-5 text-lg text-white font-bold">Make a youtube Video</h2>
       <div className="ml-5 text-sm pr-2 pt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. maxime nam excepturi consequatur debitis laborum explicabo vero sunt sit ipsum?</div>
