...
const Createtaskhandler=(e)=>{
  e.preventDefault();
const data1=(data.employee.find((e)=>e.name==assignemployee && e.id==id));
console.log(data1);

 
// localStorage.setItem("Task",[JSON.stringify({assignemployee,task,Submissiondate,Category,description})])
